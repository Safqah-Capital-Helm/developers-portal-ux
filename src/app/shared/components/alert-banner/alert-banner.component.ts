...
@Component({
  ...
  template: `
    <div class="alert-banner" *ngIf="visible"
      ...
      <button class="dismiss" *ngIf="dismissible" (click)="dismiss()" aria-label="Dismiss alert">
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none"
             stroke="${C.g400}" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
