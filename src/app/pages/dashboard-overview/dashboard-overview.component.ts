...
@Component({
  ...
  template: `
    <div class="container">
      <app-page-header title="Welcome back, Ahmed" subtitle="Manage your companies, projects, and team from one place."></app-page-header>

      <!-- Stats row -->
      <div class="stats-row">
        <app-stat-card label="Companies" [value]="2" [iconBg]="C.blue50"
          icon='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="${C.blue500}" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 21h18"/><path d="M5 21V7l8-4v18"/><path d="M19 21V11l-6-4"/></svg>'></app-stat-card>
        <app-stat-card label="Active Projects" [value]="7" [iconBg]="C.greenLt"
          icon='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="${C.green}" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 3h7l2 2h9v16H3z"/></svg>'></app-stat-card>
        <app-stat-card label="Team Members" [value]="4" [iconBg]="C.amber50"
          icon='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="${C.amber500}" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 00-3-3.87"/><path d="M16 3.13a4 4 0 010 7.75"/></svg>'></app-stat-card>
        <app-stat-card label="Pending Reviews" [value]="2" [iconBg]="C.g100"
          icon='<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="${C.g500}" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>'></app-stat-card>
      </div>
      ...
      <div class="section">
        ...
        <app-list-card *ngFor="let app of recentApplications" [statusColor]="app.sc" (click)="onAppClick(app)">
